...
export function Extructure({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="bg-zinc-50 min-h-screen w-full flex flex-col">
            ...
            >
                <div
                    className={`inset-x-0 top-0 z-50 backdrop-blur lg:backdrop-blur-none duration-200 border-b lg:bg-transparent ${isIntersecting
                ...
                >
                    <div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto ">
                        <div className="flex justify-between gap-8">
                            ...
                            <Link target="_blank" href="https://github.com/GabrielBorges2000">
                                <Github
