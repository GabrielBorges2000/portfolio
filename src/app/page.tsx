...
export const socials = [
	...
	{
		icon: <Phone size={20} />,
		href: "http://api.whatsapp.com/send?phone=11986237504",
		label: "Contato",
		handle: "11 98623-7504",
	},
	...
	return (
		<div className="flex flex-col items-center justify-center w-screen h-screen max-h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
			...
			<div className="flex flex-row gap-8 text-center animate-fade-in">
				{socials.map((s) => (
					<Link key={s.href} href={s.href} target="_blank" className="flex flex-col items-center text-zinc-300" title={s.handle}>
