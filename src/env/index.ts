...
if (typeof window === 'undefined') {
  ...
  env = {
    ...
    NEXT_PUBLIC_REPOSITORIES_EMPHASIS_ARRAY: process.env.NEXT_PUBLIC_REPOSITORIES_EMPHASIS_ARRAY?.split(','),
    NEXT_PUBLIC_REPOSITORIES_ARRAY: process.env.NEXT_PUBLIC_REPOSITORIES_ARRAY?.split(','),
  }
}
